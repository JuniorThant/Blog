...
<html lang="en">
 ...
 <ul class="dropdown-menu bg-dark">
    ...
    <li><a class="dropdown-item text-white" href="#staticBackdrop" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
    <i class="bi bi-box-arrow-left text-white"></i> Logout</a></li>
  </ul>
</div>
