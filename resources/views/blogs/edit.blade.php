        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card p-5 my-5 shadow-sm">
                    <form method="POST" enctype="multipart/form-data" id="updateblogForm">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="thumbnail" name="thumbnail" id="avatarInput" style="display: none;">
                            <x-error name="thumbnail"/>
                        </div>

                        <div class="mb-3">
                            <select name="category_id" id="scrollstop" class="form-control">
